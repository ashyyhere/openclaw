...
type MonitorWebInboxOptions = {
  ...
  accountId: string;
  authDir: string;
  onMessage: (msg: WebInboundMessageWithDeprecatedAliases) => Promise<void>;
  mediaMaxMb?: number;
  ...
  shouldDebounce?: (msg: WebInboundMessageWithDeprecatedAliases) => boolean;
...
export async function attachWebInboxToSocket(
  ...
  type QueuedInboundMessage = WebInboundMessageWithDeprecatedAliases & QueuedInboundMessageMetadata;
  ...
  const buildInboundDebounceKey = (msg: WebInboundMessageWithDeprecatedAliases): string | null => {
  ...
  const shouldDebounceInboundMessage = (msg: WebInboundMessageWithDeprecatedAliases): boolean =>
