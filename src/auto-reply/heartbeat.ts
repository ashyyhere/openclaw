...
/** Task definition parsed from HEARTBEAT.md for scheduled heartbeat turns. */
...
/** Returns a configured heartbeat prompt or the built-in default prompt. */
...
/** Returns a heartbeat prompt that includes heartbeat_respond tool instructions. */
...
/** Strips HEARTBEAT_OK acknowledgements and decides whether delivery should be skipped. */
