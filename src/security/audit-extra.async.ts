...
/** Security audit finding emitted by deep async collectors. */
...
/** Delegates plugin trust checks through a lazy import to keep startup light. */
...
/** Checks running sandbox browser containers for drift labels and unsafe port publishes. */
...
/** Audits recursively included config files for unsafe read/write permissions. */
...
/** Audits state files that can expose credentials, sessions, or private logs. */
...
/** Reads the config snapshot through the normal config I/O path for audit callers. */
...
/** Runs deep static code-safety scans for installed plugins. */
...
/** Runs deep static code-safety scans for installed non-bundled skills. */
