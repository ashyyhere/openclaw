...
/** Resolve a model config's primary model string from string or object input. */
...
/** Resolve fallback model strings from object-style model config. */
...
/** Resolve a positive integer timeout from tool model config. */
...
/** Convert string/object model config into the list-like shape used by selection code. */
...
/** Normalize provider/model references for config map keys, including provider-specific aliases. */
...
/** Normalize all model-map keys and merge entries that collapse to the same provider/model ref. */
