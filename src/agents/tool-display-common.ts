...
/** Display metadata used to render tool progress titles and details. */
...
/** Parsed target for bridge code generated by tool search. */
...
/** Normalize an optional tool name to the generic fallback name. */
export function normalizeToolName(name?: string): string {
  return (name ?? "tool").trim();
}

/** Convert an internal tool key into a title-cased display label. */
...
/** Resolve display verb/detail text from tool args, metadata, and display specs. */
...
/** Convert a raw args path into a compact display label. */
...
/** Parse tool-search bridge code into a display target and preview args. */
...
/** Normalize and optionally prefix rendered tool detail text. */
